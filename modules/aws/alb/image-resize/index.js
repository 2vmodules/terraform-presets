...
const BUCKET = 'dev-legally-media-bucket';
const SSM_SECRET_KEY = 'dev-legally-image-resize-secret-key';
const GET_DOCUMENT_DATA_API_URL = `https://api.app.legally.io/api/_/get-document-data`;
const HTML_TO_PDF_URL = 'https://api.app.legally.io/___/html-to-pdf';
const HTML_TO_DOCX_URL = 'https://api.app.legally.io/___/html-to-docx';
...
// https://cdn.dev.legally.io/documents/{id}/name-v4.docx?signature=<signature>
// https://cdn.dev.legally.io/documents/{id}/name-v4.pdf?signature=<signature>
// https://cdn.dev.legally.io/documents/{id}/name-v4-p0-300x300-inside-ww.webp?signature=<signature>
// https://cdn.dev.legally.io/documents/{id}/name-v4-p0-300x300-inside-nw.webp?signature=<signature>
/**
 * @param {string} path
